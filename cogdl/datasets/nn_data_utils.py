# -*- coding: utf-8 -*-
# @Author: lxy
# @Date:   2019-12-30 10:27:25
# @Last Modified by:   lxy
# @Last Modified time: 2019-12-30 18:32:47
...
import sys
sys.path.append('E:/工作准备/code/cogdl-july')
...
def normalize_adj(adj, symmetric=True):
    if symmetric:
        ...
        a_norm = adj.dot(d).transpose().dot(d).todense()
    else:
...
if __name__ == '__main__':
    features, adj, labels = load_npy_data('E:/工作准备/code/cogdl-july/dataset/raw/cora', 'cora')
